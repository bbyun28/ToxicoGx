...
create_phenoData <- function(species=c("Human","Rat"), verbose = TRUE){
  ...
  # all_attribute$SPECIES <- "R.norvegicus"
  # saveRDS(all_attribute, "data/Open-tggates_AllAttribute.rds")
...
saveRDS(tggates_human_ldh, "TGGATES_humanldh.rds")
saveRDS(tggates_human_dna, "TGGATES_humandna.rds")
